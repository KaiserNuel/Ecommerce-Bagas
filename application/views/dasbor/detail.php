    ...
    <table class="table table-bordered stext-107">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>: 
                    <?php 
                    // Hitung tanggal pengiriman (+5 hari)
                    $tanggal_pengiriman = date('d-m-Y', strtotime($header_transaksi->tanggal_transaksi . ' + 5 days'));
                    // Konversi hari ke bahasa Indonesia
                    $hari = date('l', strtotime($tanggal_pengiriman));
                    $hari_indonesia = [
                        'Monday'    => 'Senin',
                        'Tuesday'   => 'Selasa',
                        'Wednesday' => 'Rabu',
                    ...
                    echo $hari_indonesia[$hari].', '.$tanggal_pengiriman;
                    ?>
                </td>
            </tr>
        </tbody>
